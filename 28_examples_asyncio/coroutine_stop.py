...
# @changelog python3 `asyncio -> coroutine stop` example


# ===============================================================================
# 标题：python3 asyncio coroutine stop example
# ===============================================================================
...
# 传入 协程 对象到事件循环中可直接运行
result = loop.run_until_complete(get_corouting())
print("result: ", result)
...
# ---------------------------------------------------------------------------
# run get corouting...
# result:  now time 1602836486.3454285
# going event loop
# stop loop
# close event loop
...
# @changelog python3 `asyncio -> as_completed` example
...
# output:
# ---------------------------------------------------------------------------
# task:  [<Task pending coro=<do_work() running at D:/work_private/python-examples/28_examples_asyncio/async_embed_completed.py:42>>, <Task pending coro=<do_work() running at D:/work_private/python-examples/28_examples_asyncio/async_embed_completed.py:42>>, <Task pending coro=<do_work() running at D:/work_private/python-examples/28_examples_asyncio/async_embed_completed.py:42>>]
# waiting:  1
# waiting:  3
# waiting:  4

...
print('是否存在：', os.access('f:/tmp.txt', os.F_OK))
print('是否可读：', os.access('f:/tmp.txt', os.R_OK))
print('是否可写：', os.access('f:/tmp.txt', os.W_OK))
print('是否可执行：', os.access('f:/tmp.txt', os.X_OK))
...
print('', os.chflags('f:/tmp.txt', stat.UF_NODUMP))
'''
...
'''
print('赋予执行权', os.chmod('f:/tmp.txt', stat.S_IXOTH))
print('赋予写权限', os.chmod('f:/tmp.txt', stat.S_IWOTH))
print('赋予读权限', os.chmod('f:/tmp.txt', stat.S_IROTH))
print('赋予全部权限', os.chmod('f:/tmp.txt', stat.S_IRWXO))
...
print(os.device_encoding(os.open("foo.txt", os.O_RDWR|os.O_CREAT)))
